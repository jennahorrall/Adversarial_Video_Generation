...
TRAIN_DIR_CLIPS="/p/lscratchh/kochansk/summer2019/jenna/rescal_gan_model/Adversarial_Video_Generation/Data/.debug/"

chmod u+rwx *

python process_data.py -n 10 -s 2 -p 100 -c $TRAIN_DIR_CLIPS -t $TRAIN_DIR > $PROCESS_DATA_LOG
