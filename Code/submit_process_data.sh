...
TRAIN_DIR_CLIPS="/p/lscratchh/kochansk/summer2019/jenna/rescal_gan_model/Adversarial_Video_Generation/Data/.rescal_skip_2_full/"

chmod u+rwx *

python process_data.py -n 200000 -s 2 -p 100 -c $TRAIN_DIR_CLIPS -t $TRAIN_DIR > $PROCESS_DATA_LOG
